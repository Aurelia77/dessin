...
export default function AutoDraw2() {
    ...
    function useDrawCercle() {
        
    }

    console.log("xMove", xMove)
    const { start, stop } = useDrawLines(canvasRef, fromPoint, setFromPoint, xMove, yMove, xIncrease, setXIncrease, yIncrease, setYIncrease, drawLine, 1)  
        ...
        <div className=' w-screen h-screen bg-[#ccc] flex justify-center items-center '>
            ...
            <div className=' w-[20%] ml-5 border border-yellow-200 '>
                ...
                {!runningCircle ?
                    ...
                    :
                    <button type='button' className='p-2 rounded-md border border-black' onClick={stopCircle} >Stop</button>
                }
            </div>*/}
                <div>
